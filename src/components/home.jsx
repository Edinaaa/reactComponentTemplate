...
import { ConnectiItAll } from './connectItAll';
import { clients as ClientData } from '../Data/client';
import { ClientCard } from './clientCadr';
...
export function Home(){
    ...
    return(
       ...
       className="how_section layout_padding"
       link="https://www.linkedin.com/in/edina-turnic-09140a32a/">
       ...
       <LayoutContainer 
       title=" Start Automatic Now" 
       buttonText="Read More" 
       className="auto_section layout_padding"
       link="https://www.linkedin.com/in/edina-turnic-09140a32a/">
         <div class="box container">
          <div class="img-box">
       ...
       <div class=" container">
        ...
        title={client.title}
        spacification={client.spacification}
        name={client.name}
        image={client.imageSrc}
        ></ClientCard>)}
